...
@section('dashboard')
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 lg:max-w-4xl">
        <div class=" bg-teal-100 text-teal-800 p-4 text-sm rounded border border-teal-300 my-3">
            Please visit again after 1-2 days to confirm your order.
        </div>
    </div>
    ...
    <div class="flex justify-center items-center h-screen">
        <p>No booking. Back to <a href="/" class="hover:underline">Home Page</a></p>
    </div>
    @endif
