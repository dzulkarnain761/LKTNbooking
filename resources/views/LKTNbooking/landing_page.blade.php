...
@section('content')
            ...
            <div class="flex justify-center items-center ">
                ...
                <div class="flex flex-col p-8 md:max-w-md">
                    ...
                    <div class="flex justify-center">
                        ...
                        <x-primary-button class="mt-8 py-4" @click="openHouse = !openHouse">Tempah
            ...
            <div class=" gap-32 md:flex md:justify-center">
                ...
                <div class="mt-10 flex justify-center items-center  ">
                    ...
                    <div class="flex flex-col p-8 md:max-w-md">
                        ...
                        <div class="flex justify-center">
                            <x-primary-button class="mt-8 py-4"> <a href="">Tempah
                                    Sekarang</a></x-primary-button>
        ...
        <section class="mt-12 md:mt-48 md:snap-center">
            ...
            <div class="flex justify-center">
                <x-primary-button class="mt-8 py-4"> <a href="{{ route('vehicle.booking.calendar') }}">Tempah
                        Sekarang</a></x-primary-button>
